...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const priceFilterButton = document.getElementById("price-filter-dropdown-button");
  const priceFilterInput = document.getElementById("price-filter-input");

  // Render products
  function renderProducts(categories) {
    allProductGrid.innerHTML = categories.map(category => `
        <div class="mb-12">
...
document.querySelector('#price-dropdown').addEventListener('change', function(event) {
